...
Aside from this, I have implemented a security measure within the Unity project, which gives me the option to encrypt save files before saving them. This is done using X-OR encryption. Data protection was one of the topics for my research reports, and encryption is one way to protect data.
